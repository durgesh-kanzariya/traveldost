...
import { Globe, LayoutDashboard, ShieldAlert, Languages, ClipboardList, Settings, MapPin, Phone, Ambulance, ScrollText, ArrowRightLeft, Menu, X } from 'lucide-react'
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button className="flex flex-col items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 p-4 transition-colors hover:bg-slate-100">
                  <ArrowRightLeft className="h-6 w-6 text-purple-600" />
